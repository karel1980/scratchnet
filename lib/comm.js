...
PeerServiceHandler.prototype.makeScratchExtensionSpec = function(localport, remoteid) {
    ...
    spec.extension = {
        ...
        "blockSpecs": [
            [" ", util.format("Send Message To %s", remoteid), "send", 1],
            [" ", "Received Message", "send-ack"],
            ["r", "NextMessage", "send-crnt-msg"],
            ["r", "LastMessage", "send-last-msg"],
            ["r", "MessagePtr", "send-ptr"],
            ["r", "MessageCount", "send-top"],
            ["b", "HasNewMessage", "send-hasNext"]
        ]
    };
